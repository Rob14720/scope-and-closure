...
function finalScore(inningsCB, inningsPlayed){
  let home = 0;
  let away = 0;
...
console.log('task 4:', getInningScore(inning, 4))
...
function scoreboard(inningScore, inningsCB, numberofInnings) {
  const scoreByInning = [];
  let homeScore = 0;
  let awayScore = 0;
  for(let i = 0; i < numberofInnings; i++){
    const currentInning = inningScore(inningsCB);
...
console.log('task scoreboard:', scoreboard (getInningScore, inning, 9));
